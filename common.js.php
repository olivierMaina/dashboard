...
function pirl_dashboard_validateData(){
	...
	if($j('#dashboard').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Dashboard", close: function(){ $j('#dashboard').focus(); $j('#dashboard').parents('.form-group').addClass('has-error'); } }); return false; };
	if($j('#category').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Category", close: function(){ $j('#category').focus(); $j('#type').parents('.form-group').addClass('has-error'); } }); return false; };
	if($j('#external_entity_name').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> External entity", close: function(){ $j('#external_entity_name').focus(); $j('#external_entity_name').parents('.form-group').addClass('has-error'); } }); return false; };
	if($j('#thread').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Thread", close: function(){ $j('#thread').focus(); $j('#thread').parents('.form-group').addClass('has-error'); } }); return false; };
	if($j('#external_contact_name').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> External contact", close: function(){ $j('#external_contact_name').focus(); $j('#external_contact_name').parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
