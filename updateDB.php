<?php
	...
	if($thisMD5==$prevMD5){
		...
		setupTable('external_contact', "create table if not exists `external_contact` (   `id` INT unsigned not null auto_increment , primary key (`id`), `last_name` VARCHAR(15) , `first_name` VARCHAR(15) , `function` VARCHAR(15) , `company_name` VARCHAR(40) ,`email` VARCHAR(80) , `phone` VARCHAR(15) , `alternate_phone` VARCHAR(15), `country` VARCHAR(40) , `info` TEXT ) CHARSET utf8", $silent);
		setupTable('internal_contact', "create table if not exists `internal_contact` (   `id` INT unsigned not null auto_increment , primary key (`id`), `cec` VARCHAR(15),`last_name` VARCHAR(15) , `first_name` VARCHAR(15) , `function` VARCHAR(15),`email` VARCHAR(80) , `phone` VARCHAR(15) , `country` VARCHAR(40) , `info` TEXT ) CHARSET utf8", $silent);
		setupTable('external_entity', "create table if not exists `external_entity` (   `id` INT unsigned not null auto_increment , primary key (`id`), `company_name` VARCHAR(40)  ,  `class` VARCHAR(40)  not null default 'D' , `primary_email` VARCHAR(40) , `alternate_email` VARCHAR(40) , `phone` VARCHAR(40) , `country` VARCHAR(40) , `street` VARCHAR(40) , `city` VARCHAR(40) , `zip` DECIMAL(15,0) , `comments` TEXT ) CHARSET utf8", $silent);
		//************************************* END ADDING **********************//
